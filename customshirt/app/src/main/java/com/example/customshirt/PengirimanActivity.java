...
public class PengirimanActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        btnProcess.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (destination.equals("")){
                    ...
                    progressDialog = new ProgressDialog(PengirimanActivity.this);
    ...
    public void popUpProvince(final EditText etProvince, final EditText etCity ) {
        ...
        alert = new AlertDialog.Builder(PengirimanActivity.this);
        ...
        ListProvince.clear();
        adapter_province = new ProvinceAdapter(PengirimanActivity.this, ListProvince);
    ...
    public void popUpCity(final EditText etCity, final EditText etProvince) {
        ...
        ListCity.clear();
        adapter_city = new CityAdapter(PengirimanActivity.this, ListCity);
        mListView.setClickable(true);
    ...
    public void popUpExpedisi(final EditText etExpedisi) {
        ...
        adapter_expedisi = new ExpedisiAdapter(PengirimanActivity.this, listItemExpedisi);
        mListView.setClickable(true);
        ...
        call.enqueue(new Callback<ItemProvince>() {
            ...
            public void onResponse(Call<ItemProvince> call, Response<ItemProvince> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(PengirimanActivity.this, error, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ItemProvince> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(PengirimanActivity.this, "Message : Error " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void getCoast(String origin,
        ...
        Call<ItemCost> call = service.getCost(
                "66277c2fe0a72d6dcbf96b55fbf3c3cf",
                origin,
                destination,
                weight,
                courier
            ...
            public void onResponse(Call<ItemCost> call, Response<ItemCost> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (statusCode == 200){
                        ...
                        Toast.makeText(PengirimanActivity.this, message, Toast.LENGTH_SHORT).show();
                    }
