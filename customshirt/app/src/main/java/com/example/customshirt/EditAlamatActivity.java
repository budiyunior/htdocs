...
public class EditAlamatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editalamat);
    ...
    public void popUpProvince(final EditText etProvince, final EditText etCity ) {
        ...
        alert = new AlertDialog.Builder(EditAlamatActivity.this);
        ...
        ListProvince.clear();
        adapter_province = new ProvinceAdapter(EditAlamatActivity.this, ListProvince);
        ...
        progressDialog = new ProgressDialog(EditAlamatActivity.this);
    ...
    public void popUpCity(final EditText etCity, final EditText etProvince) {
        ...
        ListCity.clear();
        adapter_city = new CityAdapter(EditAlamatActivity.this, ListCity);
        mListView.setClickable(true);
        ...
        call.enqueue(new Callback<ItemProvince>() {
            ...
            public void onResponse(Call<ItemProvince> call, Response<ItemProvince> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(EditAlamatActivity.this, error, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ItemProvince> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(EditAlamatActivity.this, "Message : Error " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
