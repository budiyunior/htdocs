            ...
            <div class="card-body">
                ...
                <form action="<?php base_url('admin/product/add') ?>" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo form_error('id_akses') ? 'is-invalid':'' ?>"type="text" name="id_akses" placeholder="ID Akses" />
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo form_error('nomor_telp') ? 'is-invalid':'' ?>"type="text" name="nomor_telp" placeholder="Nomor Telp" />
                        <div class="invalid-feedback">
